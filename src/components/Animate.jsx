...
export default function Animate() {
  return (
    <div>
         ...
         <button className='border-none rounded-full px-10 py-2 bg-red-400 absolute ml-150 mt-30 z-1 cursor-pointer hover:bg-gray-500 hidden lg:block'>Follow @Prabesh</button>
